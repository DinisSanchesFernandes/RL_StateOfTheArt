...
from Policy_discontinuous import DiscretePolicy
from Value import Value
from ppo_step import ppo_step
from GAE_tf2 import estimate_advantages
from MemoryCollector_tf2 import MemoryCollector
...
class PPO:
    ...
    def _init_model(self):
        ...
        # Define Object And critic Objects
        if env_continuous:
        ...
        if self.ppo_mini_batch_size:
            ...
            for e in range(self.ppo_epochs):
                ...
                for i in range(mini_batch_num):
                    ...
                    print("Shape: ",batch_state[ind].shape)
                    print("Shape: ",batch_return[ind].shape)
                    print("Shape: ",batch_advantage[ind].shape)
                    print("Shape: ",batch_log_prob[ind].shape)
