...
# This class inits the Replay Memory
...
# This implments the probability of Exploration
...
# This Class gets the state and returns the argmax action
#   =>Strategy is the object From Epsilon Greedy
